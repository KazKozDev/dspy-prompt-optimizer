...
class WebSearchTool(BaseTool):
    ...
    def _search_tavily(self, query: str) -> List[Dict[str, str]]:
        ...
        try:
            ...
            raise ImportError("tavily-python required. Install with: pip install tavily-python")
    ...
    def _search_duckduckgo(self, query: str) -> List[Dict[str, str]]:
        ...
        try:
            ...
            raise ImportError("duckduckgo-search required. Install with: pip install duckduckgo-search")
    ...
    def run(self, query: str = "", **kwargs) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                success=True,
                output="\n".join(output_lines),
                metadata={"query": query, "num_results": len(results), "results": results}
            )
