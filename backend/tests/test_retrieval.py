...
class MockRetriever(BaseRetriever):
    ...
    def search(self, query, k=5):
        ...
        return RetrievalResult(
            passages=results[:k], scores=scores[:k], metadata=meta[:k]
        )
...
class TestBaseRetriever:
    ...
    def test_index_and_search(self):
        ...
        retriever.index(["The quick brown fox", "The lazy dog", "A quick rabbit"])
    ...
    def test_search_with_k(self):
        ...
        retriever.index(["apple pie", "apple juice", "apple sauce", "apple cider"])
    ...
    def test_index_with_metadata(self):
        ...
        retriever.index(["doc1", "doc2"], metadata=[{"source": "a"}, {"source": "b"}])
    ...
    def chroma_retriever(self):
        ...
        try:
            ...
            retriever = ChromaRetriever(
                collection_name="test_collection", persist_directory=None  # In-memory
            )
            yield retriever
            retriever.clear()
        except ImportError:
