...
class TestAgentConfig:
    ...
    def test_to_dict(self):
        ...
        assert data["target_model"] == "openai/gpt-4o"
...
class TestTaskAnalyzer:
    ...
    def test_classification_detection(self):
        ...
        analysis = self.analyzer.analyze("Classify customer reviews as positive or negative")
    ...
    def test_rag_detection(self):
        ...
        analysis = self.analyzer.analyze("Answer questions using retrieval from knowledge base")
    ...
    def test_domain_detection_finance(self):
        ...
        analysis = self.analyzer.analyze("Analyze financial reports and investment data")
...
class TestOptimizerSelector:
    ...
    def test_medium_dataset_uses_random_search(self):
        ...
        analysis = TaskAnalysis()
        config = self.selector.select(analysis, dataset_size=35, quality_profile="BALANCED")
    ...
    def test_large_dataset_high_quality_uses_mipro(self):
        ...
        analysis = TaskAnalysis()
        config = self.selector.select(analysis, dataset_size=60, quality_profile="HIGH_QUALITY")
    ...
    def test_fast_cheap_always_bootstrap(self):
        ...
        analysis = TaskAnalysis()
        config = self.selector.select(analysis, dataset_size=100, quality_profile="FAST_CHEAP")
