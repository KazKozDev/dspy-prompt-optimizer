...
class TokenF1Metric(BaseMetric):
    ...
    def __init__(self, output_field: str = "result", case_sensitive: bool = False):
    ...
    def compute_detailed(self, example: Any, prediction: Any) -> dict:
        ...
        precision = (
            len(intersection) / len(predicted_tokens) if predicted_tokens else 0.0
        )
