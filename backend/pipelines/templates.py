...
def build_from_template(template_name: str, tools: Optional[List] = None) -> Optional[PipelineBuilder]:
    """
...
def suggest_template(task_type: str, needs_retrieval: bool = False, needs_tools: bool = False) -> str:
    """
