...
class ToolSelector:
    ...
    KEYWORD_TOOL_MAP = {
        "calculator": [
            ...
            "equation", "number", "sum", "average", "percentage"
        ],
        "web_search": [
            "search", "find", "look up", "current", "recent", "latest",
            "news", "today", "2024", "2025"
        ],
        "python_repl": [
            "code", "execute", "run", "script", "program", "data",
            "process", "analyze data", "pandas", "numpy"
        ],
        "wikipedia": [
            "wikipedia", "encyclopedia", "who is", "what is", "history",
            "biography", "definition", "explain"
        ],
    }
